    ...
    <li class="yamm-content">
        <div class="row">
            ...
            <div class="dropdown-banner-holder">
                <a href="#"><img alt="" src="template/assets/images/banners/banner-side.png" /></a>
            </div>
        </div><!-- /.row -->
    </li><!-- /.yamm-content -->                    
</ul><!-- /.dropdown-menu -->
...
<div id="product-tabs-slider" class="scroll-tabs outer-top-vs wow fadeInUp">
	<div class="more-info-tab clearfix ">
	   <h3 class="new-product-title pull-left">Sản phẩm mới</h3>
		...
		<li><a data-transition-type="backSlide" href="#apple" data-toggle="tab">Tìm thấy {{count($new_food)}} sản phẩm</a></li>
		</ul>
	</div>
			...
			<div class="item item-carousel">
				<div class="products">
					<div class="product">		
						<div class="product-image">
							<div class="image">
							<a href="detail.html"><img  src="template/assets/images/hinh_mon_an/{{$new->image}}" alt=""></a>
							</div><!-- /.image -->			
							<div class="tag new"><span>new</span></div>                        		   
						</div><!-- /.product-image -->
						<div class="product-info text-left">
						<h3 class="name"><a href="detail.html">{{$new->name}}</a></h3>
							<div class="rating rateit-small"></div>
